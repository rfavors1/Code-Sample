...
<title>Church Name Search</title>
<style type="text/css">
<!--
body {
...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <p><strong>Search by Church Name:</strong></p>
  <?php
  $churchl = $_POST['churchl'];
  $searchchurch = '%' . $churchl . '%';
...
$query="SELECT * FROM $TableName WHERE `Name of Church` LIKE '$searchchurch'";
