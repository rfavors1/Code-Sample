...
<div class="container">
 ...
 <div id="centeredmenu">
  ...
  <p align="center">&nbsp;</p>
<p align="center"><font color="#990000" size="+3"><strong><u>CHECK OUT</u></strong></font></p>
<p align="center">Thank for your Gift. Please continue by providing contact information. Once you complete your request, you will be sent an e-mail with contact information on how to fulfill the request.</p>
<table width="98%" align="center">
<tr>
<td width="60%" valign="top">
<form action="submitcheckout.php" method="post" name="Checkout" id="Checkout" onsubmit="return validateForm();">
<P>Name*:
              <input type="text" name="name" id="contactname" required="required"/>
            </p>
            <P>Organization*:
              <input type="text" name="org" id="org" required="required"/>
            </p>
            <p> Email*:
              <input type="text" name="email" id="contactemail" required="required"/>
            </p>
             <p> Phone Number*:
              <input type="text" name="phone" id="phone" required="required"/> <i>(Format: 5552223333)</i>
            </p>
            <p>Additional Comments*:
              <textarea name="comment" id="contactcomment" cols="45" rows="5"></textarea>
            </p>
            <div align="center">
              <input type="submit" name="submit" id="submit" value="Submit" />
              &nbsp;&nbsp;
              <a href="cart.php"><font color="#990000"><u>GO BACK</u></font></a>
              		  <p align="center">&nbsp;</p>
          <p align="center">&nbsp;</p>
		  <p align="center">&nbsp;</p>
          <p align="center">&nbsp;</p>
...
$amount=$row['Amount'];
   ...
   <td width='30%' align='right'><strong>" . $city . ", " . $state. "</strong></td>
   <tr><td colspan='2'>
   <table>
   <tr>
 ...
 echo("<tr><td colspan='2' valign='top'><strong>Billing Amount:</strong> $" . $amount . "</td></tr>");
   }
   echo("</table><hr border='1' color='#990000' width='100%'><p>&nbsp;</p>");
}
