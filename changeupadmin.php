...
<?php
	$Valid = $_GET['valid'];
  if ($Valid == 'No') {
	echo("<p><h5><font color='#FF0000'>The new e-mail address you updated is already taken. Please enter a new e-mail address or login with your e-mail address to update your information.</font></h5>");
}
?>
<h1><strong>Update Information:</strong></h1>
  ...
  <form action="confirmupadmin.php" method="post" name="UpdateForm" id="UpdateForm" onsubmit="return validateForm();">
<table width = "60%" border="0" align="center">
<?php


 echo "<tr><td>Name of Church:&nbsp;&nbsp;</td><td><input type='text' name='name' id='nameChurch' size='50' required='required' value='" . $_SESSION['namec']  . "'/></td></tr><tr><td>Name of Representative:&nbsp;&nbsp;</td><td><input type='text' name='Rep' id='nameRep' required='required' value='" . $_SESSION['repc']  . "'/></td></tr><tr><td>Address:&nbsp;&nbsp;</td><td><input type='text' name='Address' id='churchAddress' size='40' required='required' value='" . $_SESSION['addressc'] . "'/></td></tr><tr><td>City:&nbsp;&nbsp;</td><td><input type='text' name='City' id='CityName' required='required' value='" . $_SESSION['cityc'] . "'/></td></tr><tr><td>State:&nbsp;&nbsp;</td><td><select name='state' size='1' required='required'/>
				  <option selected='"  . $_SESSION['statec'] . "'/>" . $_SESSION['statec'] . "</option>
                  <option value=''></option>
                ...
                </select>             </td></tr><tr><td>Zip Code:&nbsp;&nbsp;</td><td><input type='text' name='Zip' id='ZipCode' size='5' maxlength='5' required='required' value='" . $_SESSION['zipc'] . "'/></td></tr><tr><td>Phone Number:&nbsp;&nbsp;</td><td><input name='telephone' id='Telephone' type='text' size='10' maxlength='10' required='required' value='" .  $_SESSION['phonec'] . "'/> <i>(format: 5551112222)</i></td></tr><tr><td>E-mail Address:&nbsp;&nbsp;</td><td><input type='text' name='newemail' id='newEmail' size='30' required='required' value='" . $_SESSION['emailc'] . "'/></td><tr><tr><td>Confirm E-mail Address:&nbsp;&nbsp;</td><td><input type='text' name='emailConf' id='emailConf' size='30' required='required' value='" . $_SESSION['emailc'] . "'/></td></tr><tr><td>Annual Conference:&nbsp;&nbsp;</td><td><input type='text' name='conf' id='AnnualConf' required='required' value='" . $_SESSION['confc'] . "'/></td></tr><tr><td>District:&nbsp;&nbsp;</td><td><input type='text' name='Dis' id='District' required='required' value='" . $_SESSION['disc'] . "'/></td></tr><input type='hidden' name='email' id='EmailAdd' size='30' required='required' value='" . $_SESSION['emailoc'] . "'/>";
?>
</table>
<p>
<h5 align="center">
  <input type="submit" name="change" id="change" value="Submit Changes" />
  &nbsp;&nbsp;&nbsp;<a href="admin.php"><img src='cancelbut.png'></p>
  </form>
        </div>
  </div>
  <div class="footer">
