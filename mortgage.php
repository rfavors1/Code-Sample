...
<title>Mortgage/Rent Requests</title>
<style type="text/css">
<!--
body {
...
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no requests for assistance with mortgage/rent at this time. Please come back soon or look at some of the other requests for assistance.<p><p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		  <p align='center'>&nbsp;</p>
...
while($row)
  {
	...
	if (($datec > $today) and ($datev > $today)){
		 if($i=="0") {
			 echo("<center><strong>Here is a list of churches requesting assistance for patrons needing help with mortgage/rent:</strong><p></center>");	 
		 }
$User = $row['Email'];
