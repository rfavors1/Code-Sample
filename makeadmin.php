...
<title>Make Administrator</title>
<style type="text/css">
<!--
body {
...
{
var z=document.forms["administrator"]["verify"].value;
if (z.length==0)
{
alert("Enter Yes or No");
document.forms["administrator"]["verify"].focus();
  return false;
  }	
}
</script>
...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <form action="verifyadmin.php" method="post" name="administrator" id="administrator" onsubmit="return validateForm();">
<h2><strong>Make Administrator</strong></h2>
<p><font color="#FF0000">Please note: As an administrator, the user will have access to full functionality of the website.</font></p> 
          <p><strong>E-Mail Address:</strong>
          <?php echo($_SESSION['emaila']);
		  ?>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Administrator:</strong> &nbsp;
          <select name="verify" size="1" required="required">
                  <option value=""></option>
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
                  </select>
                  </p><p>
                  <input type="submit" name="singup" id="singup" value="Submit" />
</p>
          <p>&nbsp;</p>
          <p align="center"><a href="admin.php"><img src='cancelbut.png'></a></p>
          <p>&nbsp;</p>
