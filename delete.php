...
<p>&nbsp;</p>
          <h2>Delete Account:</h2>
            <p>Are you sure you want to delete your account? Deleting your account is PERMANENT and you will have to register again before logging into the site. Your requests for assistant will also be permanently deleted.</p>
            <center>
            <p><a href="deletesubmit.php"><img src='deletebut.png'></font></a>&nbsp;&nbsp;&nbsp;<a href="update.php"><img src='cancelbut.png'></a></p>
            </center>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
