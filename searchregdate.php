...
<title>Search Accounts by Date - Admin</title>
<style type="text/css">
<!--
body {
...
<p align='center'>&nbsp;</p>");
	...
	while($row)
  {
	  $registerdate = $row['DateRegister'];
	  $i++;
	  if ((strtotime($registerdate) >= strtotime($newdatefrom)) and (strtotime($registerdate) <= strtotime($newdateto))) {
