...
{
var x=document.forms["PasswordRequest"]["email"].value;
var atpos=x.indexOf("@");
...
$Valid = $_GET['valid'];
if ($Valid == 'no') {
	echo ("<p align='left'><font color='#FFOOOO'>Invalid e-mail address. Please try again.</font></p>");
}
?>
            <form action="passwordsent.php" method="post" name="PasswordRequest" id="PasswordRequest" onsubmit="return validateForm();">
            <p>Please enter the e-mail address you provided during registration in order to retrieve password.</p>
            <p><strong>E-mail:</strong>
            <input type="text" name="email" id="email" size="30"/>            
            <p></p><p></p> 
              <input type="submit" name="request" id="request" value="Send Password" />
               </form></p>
            </font></p>
            <p>&nbsp;</p>
</div>
