...
$query="SELECT * FROM $TableName WHERE Email = '$User' AND Deleted != '$up'";
...
if (!$row) {
		echo("<p align='center'>&nbsp;</p><div align='center'>You do not have any requests for assistance at this time.<p></p><p></p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		    <p align='center'>&nbsp;</p>
...
<p align='center'>&nbsp;</p>");
	...
	$i = "0";
echo("<center><strong>Here is a list of requests for assistance you have submitted:</strong><p></p></center>");
while($row)
  {
$ID=$row['ID'];
$Type=$row['Type'];
