...
<div id="centeredmenu">
  ...
  Please confirm your information is correct before submitting your registration.
  <p></p>
  <?php
    $Name = $_POST['name'];
$Rep = $_POST['Rep'];
...
<p></p>
<form action='register.php' method='post' name='RegistrationForm' id='RegistrationForm'>
	 ...
	 <input type='hidden' name='Zip' id='ZipCode' size='5' maxlength='5' required='required' value='" . $Zip . "'/>
	  <input name='telephone' id='Telephone' type='hidden' size='10' maxlength='10' required='required' value='" . $Telephone . "'/>
		...
		<input type='hidden' name='Dis' id='District' required='required' value='" . $Dis . "'/>
		  <input type='hidden' name='email' id='EmailAdd' size='30' required='required' value='" . $Email . "'/>
		    <input type='hidden' name='password' id='pass' required='required' value='" . $Pass . "'/>
			<center><input type='submit' name='singup' id='singup' value='Submit Registration' /></form>&nbsp;&nbsp;<a href='exist.php'><font color='#990000'><u>GO BACK</u></font></a>
");
