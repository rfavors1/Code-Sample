...
-->
 ...
 echo "<tr><td>Name of Church:&nbsp;&nbsp;</td><td><input type='text' name='name' id='nameChurch' size='50' required='required' value='" . $row['Name of Church']  . "'/></td></tr><tr><td>Name of Representative:&nbsp;&nbsp;</td><td><input type='text' name='Rep' id='nameRep' required='required' value='" . $row['Name of Representative']  . "'/></td></tr><tr><td>Address:&nbsp;&nbsp;</td><td><input type='text' name='Address' id='churchAddress' size='40' required='required' value='" . $row['Church Address'] . "'/></td></tr><tr><td>City:&nbsp;&nbsp;</td><td><input type='text' name='City' id='CityName' required='required' value='" . $row['City'] . "'/></td></tr><tr><td>State:&nbsp;&nbsp;</td><td><select name='state' size='1' required='required'/>
				  <option selected='"  . $row['State'] . "'/>" . $row['State'] . "</option>
                  <option value=''></option>
                ...
                </select>             </td></tr><tr><td>Zip Code:&nbsp;&nbsp;</td><td><input type='text' name='Zip' id='ZipCode' size='5' maxlength='5' required='required' value='" . $row['Zipcode'] . "'/></td></tr><tr><td>Phone Number:&nbsp;&nbsp;</td><td><input name='telephone' id='Telephone' type='text' size='10' maxlength='10' required='required' value='" .  $row['Church Phone Number'] . "'/> <i>(format: 5551112222)</i></td></tr><tr><td>E-mail Address:&nbsp;&nbsp;</td><td><input type='text' name='newemail' id='newEmail' size='30' required='required' value='" . $_SESSION['emaila'] . "'/></td></tr><tr><td>Confirm E-mail Address:&nbsp;&nbsp;</td><td><input type='text' name='emailConf' id='emailConf' size='30' required='required' value='" . $_SESSION['emaila'] . "'/></td></tr><tr><td>Annual Conference:&nbsp;&nbsp;</td><td><input type='text' name='conf' id='AnnualConf' required='required' value='" . $row['Name of Annual Conference'] . "'/></td></tr><tr><td>District:&nbsp;&nbsp;</td><td><input type='text' name='Dis' id='District' required='required' value='" .$row['Name of District'] . "'/></td></tr><input type='hidden' name='email' id='EmailAdd' size='30' required='required' value='" . $_SESSION['emaila'] . "'/>";
}
?>
</table>
<p>&nbsp;</p>
<p align='center'>
  ...
  &nbsp;&nbsp;&nbsp;<a href="admin.php"><img src="cancelbut.png"></a></p>
  </form>
        </div>
  </div>
  <div class="footer">
