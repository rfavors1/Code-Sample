...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <p><strong>Search by E-mail Address:</strong></p>
  <?php
  $emaill = $_POST['emaill'];
  $searchemail = '%' . $emaill . '%';
...
$query="SELECT * FROM $TableName WHERE Email LIKE '$searchemail'";
...
<p align='center'>&nbsp;</p>");
  ...
  {
	  $i++;
	  echo("<p><a href='accountdetails.php?emaill=" . $row['Email'] . "'><font color='#990000'><u><strong>" . $row['Email'] . "</strong></u></font></a> ");
	  If ($row['Deleted'] == 'Yes') {
