...
<strong>&nbsp;&nbsp;&nbsp;Register Your Church</strong><br />
          ...
          <hr size="3" border="none" color="#990000" align="left" width="75%" />
          <form action="regconfirm.php" method="post" name="RegistrationForm" id="RegistrationForm" onsubmit="return validateForm();">
        
            <br />
              <p>Name of Church:
  <input type="text" name="name" id="nameChurch" size="50" required="required"/>
              </p>
              <p>Name of Representative:
  <input type="text" name="Rep" id="nameRep" required="required"/>
              </p>
              <p>Church Address:
  <input type="text" name="Address" id="churchAddress" size="40" required="required"/>
              </p>
              <p>City:
  <input type="text" name="City" id="CityName" required="required"/>
                &nbsp;&nbsp;&nbsp;State:
                ...
                &nbsp;&nbsp;&nbsp;Zip Code:
                <input type="text" name="Zip" id="ZipCode" size="5" maxlength="5" required="required"/>
              </p>
              <p>Church Telephone Number:
  <input name="telephone" id="Telephone" type="text" size="10" maxlength="10" required="required" />
                <i>(format: 5551112222)</i>
              </p>
              <p>Annual Conference:
  <input type="text" name="conf" id="AnnualConf" required="required"/>
                District:
                <input type="text" name="Dis" id="District" required="required"/>
              </p>
              <p>E-mail Address:
  <input type="text" name="email" id="EmailAdd" size="30" required="required"/>
                &nbsp;&nbsp;&nbsp;Confirm E-mail:
                <input type="text" name="emailConf" id="ConfEmail" size="30" required="required"/></p>
              <p>Password:
  <input type="password" name="password" id="pass" required="required"/>
              ...
              <p>You must agree to the following:</p>
              <p>
