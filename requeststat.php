...
<title>Request Status - Admin</title>
<style type="text/css">
<!--
body {
...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <strong><h2>Search by Status:</h2></strong>
  <table width="60%" align='center'>
  <tr>
  <?php
  
  $stata = $_GET['stata'] ;
  if ($stata == 'unfulfilled') {
  echo("<td><a href='requeststat.php?stata=unfulfilled'><font color='#000000'><u><strong>Unfulfilled</strong></u></font></a></td>");
  } else {
	  echo("<td><a href='requeststat.php?stata=unfulfilled'><font color='#990000'><u><strong>Unfulfilled</strong></u></font></a></td>");
  }
   if ($stata == 'fulfilled') {
  echo("<td><a href='requeststat.php?stata=fulfilled'><font color='#000000'><u><strong>Fulfilled</strong></u></font></a></td>");
    } else {
		  echo("<td><a href='requeststat.php?stata=fulfilled'><font color='#990000'><u><strong>Fulfilled</strong></u></font></a></td>");
	}
 if ($stata == 'pending') {
  echo("<td><a href='requeststat.php?stata=pending'><font color='#000000'><u><strong>Pending</strong></u></font></a></td>");
    } else {
		echo("<td><a href='requeststat.php?stata=pending'><font color='#990000'><u><strong>Pending</strong></u></font></a></td>");
	}
	 if ($stata == 'expired') {
  echo("<td><a href='requeststat.php?stata=expired'><font color='#000000'><u><strong>Expired</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requeststat.php?stata=expired'><font color='#990000'><u><strong>Expired</strong></u></font></a></td>");	
	}
  echo("</tr>
  </table>");
  echo("<h3>"); 
    if ($stata == 'unfulfilled') {
		 echo("<p><strong><u>Unfulfilled</u></strong></p>");
  }
   if ($stata == 'fulfilled') {
	    echo("<p><strong><u>Fulfilled</u></strong></p>");
    }
 if ($stata == 'pending') {
	  echo("<p><strong><u>Pending</u></strong></p>");
    }
	 if ($stata == 'expired') {
   echo("<p><strong><u>Expired</u></strong></p>");
    } 
	echo("</h3>");
...
$query="SELECT * FROM $TableName WHERE Status = '$stata' AND Deleted !='$up'";
}
	...
	while($row)
  {
	...
	if ($stata == 'expired') {
		if (($datec < $today) and ($datev < $today)){
			 echo("<tr><td><a href='requestdetails.php?ID=" . $row['ID'] . "'><font color='#990000'><u><strong>" . $row['ID'] . "</strong></u></font></a> </td><td><strong>" . $row['Type'] . "</strong></td><td><strong>" . $row['Email'] . "</strong></td></tr>");
		}
	} else {
	if (($datec > $today) and ($datev > $today)){
	  echo("<tr><td><a href='requestdetails.php?ID=" . $row['ID'] . "'><font color='#990000'><u><strong>" . $row['ID'] . "</strong></u></font></a> </td><td><strong>" . $row['Type'] . "</strong></td><td><strong>" . $row['Email'] . "</strong></td></tr>");
