...
<title>Electrician Requests</title>
<style type="text/css">
<!--
body {
...
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no requests for electrician services at this time. Please come back soon or look at some of the other requests for assistance.<p><p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		  <p align='center'>&nbsp;</p>
...
while($row)
  {
	...
	if ($datec > $today) {
				 if($i=="0") {
		echo("<center><strong>Here is a list of churches requesting assistance with electrician services.</strong><p></center>");
		 }
$User = $row['Email'];
