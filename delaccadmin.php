...
<p>&nbsp;</p>
          ...
          <p> <?php echo("<strong>E-mail Address:</strong> " . $_SESSION['emaila']); ?></p>
            <p>Are you sure you want to delete this account? Deleting this account is PERMANENT and the user will have to register again before logging into the site. The requests for assistant will also be permanently deleted.</p>
            <center>
            <p><a href="deleteadminsubmit.php"><img src='deletebut.png'></font></a>&nbsp;&nbsp;&nbsp;<a href="admin.php"><img src='cancelbut.png'></a></p>
            </center>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
