...
<title>Admin - Look Up Request</title>
<style type="text/css">
<!--
body {
...
{
var request=document.forms["SearchRequest"]["requestl"].value;
if (request.length==0)
{
alert("Enter a ID");
document.forms["SearchRequest"]["requestl"].focus();
  return false;
  }	
  if ((isNaN(request))) {
...
<div id="centeredmenu">
  ...
  <p align="center">&nbsp;</p>
  <h2><u>Requests</u></h2>
  <p><strong>Search by Status:</strong></p>
  <table width="60%" align='center'>
  <tr>
  <td><a href="requeststat.php?stata=unfulfilled"><font color="#990000"><u><strong>Unfulfilled</strong></u></font></a></td>
  <td><a href="requeststat.php?stata=fulfilled"><font color="#990000"><u><strong>Fulfilled</strong></u></font></a></td>
  <td><a href="requeststat.php?stata=pending"><font color="#990000"><u><strong>Pending</strong></u></font></a></td>
  <td><a href="requeststat.php?stata=expired"><font color="#990000"><u><strong>Expired</strong></u></font></a></td>
  </tr>
  </table>
  <p><strong>Search by Type:</strong></p>
  <table width="80%" align='center'>
  <tr>
  <td><a href="requesttype.php?typea=telephone"><font color="#990000"><u><strong>Telephone</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=electric"><font color="#990000"><u><strong>Electricity/Gas</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=mortgage"><font color="#990000"><u><strong>Mortgage/Rent</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=accountant"><font color="#990000"><u><strong>Accountant</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=electrician"><font color="#990000"><u><strong>Electrician</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=plumber"><font color="#990000"><u><strong>Plumber</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=food"><font color="#990000"><u><strong>Food</strong></u></font></a></td>
  <td><a href="requesttype.php?typea=clothing"><font color="#990000"><u><strong>Clothing</strong></u></font></a></td>
  </tr>
  </table>
   <p><strong>Search by Date: </strong></p>
   <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="requestdate.php?datea=30"><font color="#990000"><u><strong>Last 30 Days</strong></u></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="requestdate.php?datea=60"><font color="#990000"><u><strong>Last 60 Days</strong></u></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="requestdate.php?datea=90"><font color="#990000"><u><strong>Last 90 Days</strong></u></font></a></p>
   <form action="searchreqdate.php" method="post" name="SearchDate" id="SearchDate" onsubmit="return validateFormD();">
   <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Between</strong> <i>(format: mm/dd/yyyy)</i><strong>:</strong> <input type="text" name="dateafrom" size="10" id="dateaa" required="required" placeholder="mm/dd/yyyy"/>&nbsp;&nbsp;<strong>and</strong>&nbsp;&nbsp;<input type="text" name="dateato" size="10" id="dateab" required="required" placeholder="mm/dd/yyyy"/>&nbsp;&nbsp;&nbsp;<input type="submit" name="singup" id="singup" value="Search" /></form></p>
   <form action="searchrequest.php" method="post" name="SearchRequest" id="SearchRequst" onsubmit="return validateForm();">
     <p><strong>Search by ID Number: </strong><input type="text" name="requestl" size="6" id="requestl" required="required"/>&nbsp;&nbsp;&nbsp;<input type="submit" name="singup" id="singup" value="Search" /></p>
     </form>
          <p>&nbsp;</p>
