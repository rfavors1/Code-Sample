...
{
var old=document.forms["PasswordForm"]["oldpassword"].value;
var newpass=document.forms["PasswordForm"]["newpassword"].value;
var confpass=document.forms["PasswordForm"]["confirmnewpassword"].value;
...
if (confpass.length == 0) {
	 ...
	 document.forms["PasswordForm"]["confirmnewpassword"].focus();
    return false;
}
}
...
<td  width="20%" valign="top"><a href="assistance.php"><font size="2"><strong>- REQUEST ASSISTANCE</strong></font></a><br />
...
<?php
	$Valid = $_GET['valid'];
  if ($Valid == 'no') {
	echo("<p>&nbsp;</p><p>&nbsp;</p><font color='#FF0000'>Your old password did not match our records. Please try again.</font><p>&nbsp;</p>");
}
?>
...
<p>&nbsp;</p>
       <center>
  <form action="confirmpassword.php" method="post" name="PasswordForm" id="PasswordForm" onsubmit="return validateForm();">
  <table width="50%" align="center">
  <tr>
  <td>Old Password:</td>
  <td> <input type="password" name="oldpassword" id="pass" required="required"/></td>
  </tr>
  <tr>
  <td>New Password:</td>
  <td><input type="password" name="newpassword" id="confpass" required="required"/></td>
  </tr>
  <tr>
  <td>Confirm New Password:</td>
  <td><input type="password" name="confirmnewpassword" id="confnewpass" required="required"/></td>
   </tr>
   </table>
   <p>&nbsp;</p>
      <p>&nbsp;</p>
   <center>
              <input type="submit" name="submit" id="Submit" value="Submit" />
                &nbsp;&nbsp;
                <a href="update.php"><font color="#990000"><u>CANCEL</u></font></a>
                </center>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
