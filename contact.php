...
var y=document.forms["Feedback"]["name"].value;
var z=document.forms["Feedback"]["comment"].value;
var r=document.forms["Feedback"]["type"].value;
var atpos=x.indexOf("@");
...
if (r.length==0)
{
alert("Enter a feedback type");
document.forms["Feedback"]["type"].focus();
  return false;
  }	
if (z.length==0)
{
alert("Enter your comment");
var z=document.forms["Feedback"]["comment"].focus();
  return false;
  }	
}
...
<div class="container">
 ...
 <div id="centeredmenu">
    ...
    <li class="last"><strong><a href="contact.php"><font size="2"  color="#000000">CONTACT</font></a></strong></li>
    </ul>
    </div>
  <!-- end .header --></div>
  <div class="content">
  <div class="contentcontainer">
        <h2>Leave a Reply</h2>
          ...
          <font size="2">&nbsp;&nbsp;&nbsp;* <i>denotes required field</i></font><br>
          <hr size="3" border="none" align="left" width="75%" color="#990000" />
          <font size="2">
          <form action="comment.php" method="post" name="Feedback" id="Feedback" onsubmit="return validateForm();">
            <p>
              Feedback Type*: 
