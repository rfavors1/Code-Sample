...
{
var x=document.forms["ConfirmRequest"]["email"].value;
var atpos=x.indexOf("@");
...
$Valid = $_GET['valid'];
if ($Valid == 'no') {
	echo ("<p align='left'><font color='#FF0000'>Invalid e-mail address. Please try again.</font></p>");
}
?>
            <form action="confirmsend.php" method="post" name="ConfirmRequest" id="ConfirmRequest" onsubmit="return validateForm();">
            <p>Please enter the e-mail address you provided during registration in order to get a duplicate confirmation e-mail.</p>
            <p><strong>E-mail:</strong>
            <input type="text" name="email" id="email" size="30"/>            
            <p></p><p></p> 
              <input type="submit" name="request" id="request" value="Send Confirmation" />
               </form></p>
            </p>
            <p>&nbsp;</p>
</div>
