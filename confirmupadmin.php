...
<div id="centeredmenu">
  ...
  <p>&nbsp;</p><p>&nbsp;</p>
  <strong>Please confirm your information is correct before submitting.</strong>
  <p></p>
  <?php
    $Name = $_POST['name'];
$Rep = $_POST['Rep'];
...
<p></p>
<form action='updateadmin.php' method='post' name='RegistrationForm' id='RegistrationForm'>
	  ...
	  <input name='telephone' id='Telephone' type='hidden' size='10' maxlength='10' required='required' value='" . $Telephone . "'/>
		...
		<input type='hidden' name='Dis' id='District' required='required' value='" . $Dis . "'/>
		  <input type='hidden' name='newemail' id='EmailAdd' size='30' required='required' value='" . $NewEmail . "'/>
		    <input type='hidden' name='email' id='EmailAdd' size='30' required='required' value='" . $Email . "'/><center><input type='submit' name='singup' id='singup' value='Submit Update' /></form>&nbsp;&nbsp;<a href='changeupadmin.php'><img src='backbut.png'></a>
");
