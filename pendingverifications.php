...
$query="SELECT * FROM $TableName WHERE Verified = 'No'";
echo("<h3><strong>Pending Verifications</h3>");
...
mysql_close();
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no pending verifications at this time.<p><p></div>
          <p align='center'>&nbsp;</p>
...
<p align='center'>&nbsp;</p>");
	...
	while($row)
  {
	  echo("<p><a href='verify.php?email=" . $row['Email'] . "'><font color='#990000'><u><strong>" . $row['Email'] . "</strong></u></font></a></p>");
	   $row = mysql_fetch_array($result);
  }
}
?>
