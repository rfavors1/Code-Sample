...
<div id="centeredmenu">
  ...
  <p>&nbsp;</p>
  Please confirm your information is correct before submitting your updated request.
  <p></p>
  <?php
$ID = $_POST['ID'];   
$Type = $_POST['Type']; 
...
<p></p>
<form action='submiteditreq.php' method='post' name='update' id='update'>
<input type='hidden' name='Status' id='Status' size='50' required='required' value='" . $Status . "'/>
 <input type='hidden' name='ContactName' id='ContactName' size='50' required='required' value='" . $ContactName . "'/>
  ...
  <input type='hidden' name='ContactZip' id='ContactZip' size='5' maxlength='5' required='required' value='" . $ContactZip . "'/>
   ...
   <input type='hidden' name='ID' id='ID' size='50' required='required' value='" . $ID . "'/>
   ...
   <input type='hidden' name='CompanyName' id='CompanyName' size='50' required='required' value='" . $CompanyName . "'/>
    ...
    <input type='hidden' name='BillingDate' id='BillingDate' size='40' required='required' value='" . $BillingDate . "'/>
	...
	<input type='hidden' name='CompanyZip' id='CompanyZip' size='5' maxlength='5' required='required' value='" . $CompanyZip . "'/>
	 ...
	 <input type='hidden' name='Amount' id='Amount' size='20' required='required' value='" . $Amount . "'/>
			...
			<center><input type='submit' name='singup' id='singup' value='Submit Request' /></form>&nbsp;&nbsp;<a href='changeeditrequest.php'><font color='#990000'><u>GO BACK</u></font></a>
");
