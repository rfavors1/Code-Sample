...
<title>Electricity/Gas Bill Requests</title>
<style type="text/css">
<!--
body {
...
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no requests for assistance with electric/gas bills at this time. Please come back soon or look at some of the other requests for assistance.<p><p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		  <p align='center'>&nbsp;</p>
...
echo("<center><strong>Here is a list of churches requesting assistance for patrons needing help with eletric/gas bills:</strong><p></center>");
...
if ((strtotime($BillingDate)) > (strtotime($row['DateExpired']))) {		 
...
$minute = floor(($diff - $years * 365*60*60*24 - $months*30*60*60*24 - $days*60*60*24 - $hour*60*60)/ 60); 
   ...
   <tr><td valign='top' width='35%'><strong>Billing Amount:</strong> $" . $amount . "<strong></td><td colspan='2' >Due Date:</strong> " . $newdateb . "</td>
   </tr>
    <tr><td colspan='3'>&nbsp;</td></tr><tr>
   <tr>
