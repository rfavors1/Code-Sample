...
if ($_GET['exist'] == 'yes') {
	echo ("<div align='center'>Already added to Grace Cart.</div><p>&nbsp;</p>");
}
if (isset($_SESSION['addedID'])) {
	if ($ID == $_SESSION['addedID']) {
		echo ("<div align='center'>Added to Grace Cart.</div><p>&nbsp;</p>");
		
	}
}
	echo(" <table width='50%' align='center' cellspacing='0' cellpadding='0'>

   <tr><td colspan='2' bgcolor='#990000'><strong><font color='#FFFFFF'>Date Requested: " . $newdate . "</font></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color='#FFFFFF'>Type: " . $row['Type'] . "<font></strong></td>
	</tr>
   <tr bgcolor='#CCCCCC'>
   <td width='70%'><strong>" . $church . "</strong></td>
   <td width='28%' align='right'><strong>" . $city . ", " . $state. "</strong></td></tr>
 ...
 echo("<tr><td colspan='2' valign='top'><strong>Billing Amount:</strong> $" . $amount .  "<strong>&nbsp;&nbsp;&nbsp;&nbsp;Due Date:</strong> " . $newdateb . "</td></tr>");
   }
   if ($ID == $_SESSION['addedID']) {
	   echo("<tr><td align='center' colspan='2'><a href='cart.php'><font color='990000'><u><strong>GO TO GRACE CART</strong></u></font></a>"); 
	   unset($_SESSION['addedID']);
   }else {
	   $_SESSION['addtocart'] = $ID;
   echo("<tr><td align='center' colspan='2'><a href='addcart.php'><font color='990000'><u><strong>ADD TO GRACE CART</strong></u></font></a>");
   }
   if ($type=='Telephone') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='telephone.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
     if ($type=='Electricity/Gas') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='electric.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
     if ($type=='Mortgage/Rent') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='mortgage.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
        if ($type=='Electrician') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='electrician.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
      if ($type=='Accountant') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='accountant.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
      if ($type=='Plumber') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='plumber.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
      if ($type=='Food') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='food.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
      if ($type=='Clothing') {
	   echo("&nbsp;&nbsp;&nbsp;&nbsp;<a href='clothing.php'><font color='990000'><u><strong>GO BACK</strong></u></font></a>");
   }
   echo("</td></tr>
 </table>");
}
