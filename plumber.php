...
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no requests for plumbing services at this time. Please come back soon or look at some of the other requests for assistance.<p><p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		  <p align='center'>&nbsp;</p>
...
while($row)
  {
	...
	if ($datec > $today) {
	 if($i=="0") {
		echo("<center><strong>Here is a list of churches requesting assistance with plumbing services.</strong><p></center>");
		 }
