...
{
var z=document.forms["VerifyForm"]["verify"].value;
if (z.length==0)
{
alert("Enter Verification");
document.forms["VerifyForm"]["verify"].focus();
  return false;
  }	
}
</script>
...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <form action="verifyconfirm.php" method="post" name="VerifyForm" id="VerifyForm" onsubmit="return validateForm();">
<h2><strong>Verify User</strong></h2>
