...
$ContactCity = $_SESSION['ContactCity'];
$ContactState = $_SESSION['ContactState'];
$ContactZip = $_SESSION['ContactZip'];
$ContactEmail = $_SESSION['ContactEmail'];
$Best = $_SESSION['best'];
$Request = $_SESSION['Comment'];
...
$CompanyZip = $_SESSION['CompanyZip'];
...
$BillingDate = str_replace("'","&#39;",$BillingDate);
  ...
  <input name='ContactNumber' id='ContactNumber' type='text' size='10' maxlength='10' required='required' value='" . $ContactNumber . "'/>
  ...
  <input type='text' name='CompanyCity' id='CompanyCity' required='required' value='" . $CompanyCity . "'/>
              ...
              <p>Phone Number:
  <input name='CompanyNumber' id='CompanyNumber' type='text' size='10' maxlength='10' required='required' value='" . $CompanyNumber . "'/>
                <i>(format: 5551112222)</i></p>
				<p>Name on Account:
  <input type='text' name='BillingName' id='BillingName' size='50' required='required' value='" . $BillingName . "'/>
              </p>
			  				<p>Due Date:
  <input type='text' name='BillingDate' id='BillingDate' size='10' required='required' value='" . $BillingDate . "'/><i>(format: mm/dd/yyyy)</i>
              </p>
			<p>Account Number: 
