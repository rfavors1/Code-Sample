...
<div class="container">
 ...
 <div id="centeredmenu">
  ...
  <p align="center">&nbsp;</p>
<p align="center"><font color="#990000" size="+3"><strong><u>GRACE CART</u></strong></font></p>
 <?php
 $deleted = $_GET['deleted'];
 if ($deleted == 'yes') {
	 echo "<p align='center'>Request Removed.</p>";
 }
...
$newdateb = substr($BillingDate,5,2) . "/" . substr($BillingDate,8,2) . "/" . substr($BillingDate,0,4);
   ...
   <tr bgcolor='#CCCCCC'>
   <td width='60%'><strong>" . $church . "</strong></td>
   <td width='20%' align='right'><strong>" . $city . ", " . $state. "</strong></td>
   <td bgcolor='#FFFFFF'width='20%' align='right'><a href='remove.php?ID=" . $ID . "'><font color='#99000'><U>(X) REMOVE</u></font></a></td></tr>
   <tr><td colspan='2'>
   <table>
   <tr>
 ...
 echo("<tr><td colspan='2' valign='top'><strong>Billing Amount:</strong> $" . $amount .  "<strong>&nbsp;&nbsp;&nbsp;&nbsp;Due Date:</strong> " . $newdateb . "</td></tr>");
   ...
   echo("</table><hr border='1' color='#990000' width='70%' align='center'><p>&nbsp;</p>");
}

}
$i++;
	}
	echo("<div align='center'><a href='checkout.php'><font color='#99000'><strong><u>CHECK OUT</u></strong></font></a></div><p align='center'>&nbsp;</p>");
} else {
	echo("<p align='center'>&nbsp;</p><p align='center'>Your Grace Cart is empty.</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p><p align='center'>&nbsp;</p>");
}
mysql_close();
