...
<div class="container">
 ...
 <div id="centeredmenu">
	...
	<li><strong><a href="time-talents.php"><font size="2">TIME &amp; TALENTS</font></a></strong></li>
        <li><strong><a href="clothing.php"><font size="2" color="#000000">CLOTHING</font></a></strong></li>
...
if (!$row) {
		echo("<div align='center'><p></p> <p align='center'>&nbsp;</p>There are no requests for clothing at this time. Please come back soon or look at some of the other requests for assistance.<p><p></div>
          <p align='center'>&nbsp;</p>
          <p align='center'>&nbsp;</p>
		  <p align='center'>&nbsp;</p>
...
while($row)
  {
	...
	if ($datec > $today) {
		 if($i=="0") {
		echo("<center><strong>Here is a list of churches requesting assistance with clothing.</strong><p></center>");
		 }
