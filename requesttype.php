...
<title>Request Type - Admin</title>
<style type="text/css">
<!--
body {
...
<div id="centeredmenu">
  ...
  <div class="contentcontainer">
    <p align="center">&nbsp;</p>
  <strong><h2>Search by Type:</h2></strong>
    <table width="80%" align='center'>
  <tr>
  <?php
  $typea = $_GET['typea'];
  if ($typea == 'telephone') {
  echo("<td><a href='requesttype.php?typea=telephone'><font color='#000000'><u><strong>Telephone</strong></u></font></a></td>");
  } else {
	  echo("<td><a href='requesttype.php?typea=telephone'><font color='#990000'><u><strong>Telephone</strong></u></font></a></td>");
  }
   if ($typea == 'electric') {
  echo("<td><a href='requesttype.php?typea=electric'><font color='#000000'><u><strong>Electricity/Gas</strong></u></font></a></td>");
    } else {
		  echo("<td><a href='requesttype.php?typea=electric'><font color='#990000'><u><strong>Electricity/Gas</strong></u></font></a></td>");
	}
 if ($typea == 'mortgage') {
  echo("<td><a href='requesttype.php?typea=mortgage'><font color='#000000'><u><strong>Mortgage/Rent</strong></u></font></a></td>");
    } else {
		echo("<td><a href='requesttype.php?typea=mortgage'><font color='#990000'><u><strong>Mortgage/Rent</strong></u></font></a></td>");
	}
	 if ($typea == 'accountant') {
  echo("<td><a href='requesttype.php?typea=accountant'><font color='#000000'><u><strong>Accountant</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requesttype.php?typea=accountant'><font color='#990000'><u><strong>Accountant</strong></u></font></a></td>");	
	}
	 if ($typea == 'electrician') {
  echo("<td><a href='requesttype.php?typea=electrician'><font color='#000000'><u><strong>Electrician</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requesttype.php?typea=electrician'><font color='#990000'><u><strong>Electrician</strong></u></font></a></td>");	
	}
	 if ($typea == 'plumber') {
  echo("<td><a href='requesttype.php?typea=plumber'><font color='#000000'><u><strong>Plumber</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requesttype.php?typea=plumber'><font color='#990000'><u><strong>Plumber</strong></u></font></a></td>");	
	}
	 if ($typea == 'food') {
  echo("<td><a href='requesttype.php?typea=food'><font color='#000000'><u><strong>Food</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requesttype.php?typea=food'><font color='#990000'><u><strong>Food</strong></u></font></a></td>");	
	}
	 if ($typea == 'clothing') {
  echo("<td><a href='requesttype.php?typea=clothing'><font color='#000000'><u><strong>Clothing</strong></u></font></a></td>");
    } else {
	  echo("<td><a href='requesttype.php?typea=clothing'><font color='#990000'><u><strong>Clothing</strong></u></font></a></td>");	
	}
  echo("</tr>
  </table>");
  echo("<h3>");
   if ($typea == 'telephone') {
  echo("<p><strong><u>Telephone</u></strong></p>");
  }
  if ($typea == 'electric') {
  echo("<p><strong><u>Electric</u></strong></p>");
    }
 if ($typea == 'mortgage') {
  echo("<p><strong><u>Mortgage</u></strong></p>");
    }
	 if ($typea == 'accountant') {
  echo("<p><strong><u>Accountant</u></strong></p>");
    }
	 if ($typea == 'electrician') {
  echo("<p><strong><u>Electrician</u></strong></p>");
    }
	 if ($typea == 'plumber') {
  echo("<p><strong><u>Plumber</u></strong></p>");
    }
	 if ($typea == 'food') {
  echo("<p><strong><u>Food</u></strong></p>");
    }
	 if ($typea == 'clothing') {
  echo("<p><strong><u>Clothing</u></strong></p>");
    }
	echo("</h3>");
...
$query="SELECT * FROM $TableName WHERE Type = '$typea' AND Deleted !='$up'";
...
<p align='center'>&nbsp;</p>");
	...
	while($row)
  {
	...
	if (($datec > $today) and ($datev > $today)){
	  echo("<tr><td><strong><a href='requestdetails.php?ID=" . $row['ID'] . "'><font color='#990000'><u><strong>" . $row['ID'] . "</strong></u></font></a></td><td><strong>" . $row['Status'] . "</strong></td><td><strong>" . $row['Email'] . "</strong></td></tr>");
	} else {
	echo("<tr><td><strong><a href='requestdetails.php?ID=" . $row['ID'] . "'><font color='#990000'><u><strong>" . $row['ID'] . "</strong></u></font></a></td><td><strong>Expired</strong></td><td><strong>" . $row['Email'] . "</strong></td></tr>");	
	}
	  $i++;
	   $row = mysql_fetch_array($result);
  }
