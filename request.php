...
<h2><strong>Request Assistance</strong></h2>
        <font color="#990000">&nbsp;&nbsp;&nbsp;You may be contacted for additiional information.</font><br />
        <i>&nbsp;&nbsp;&nbsp;All fields are required</i><br>
        <hr size="3" align="left" border="none" color="#990000" width="75%" />
    <form action="confirmrequest.php" method="post" name="Request" id="Request" onsubmit="return ValidateForm();">
    <?php 
	$Type = $_GET['type'];
	echo("
   <p>Assistance Type: <u>" . $Type . "</u><input type='hidden' name='Type' id='Type' size='30' required='required' value='" . $Type . "'/>"); 
				?>
               <p><strong>Contact Information:</strong></p> 
              <p>Contact Name:
  <input type="text" name="ContactName" id="ContactName" size="50" required="required"/>
              </p>
              <p>Contact Address:
  <input type="text" name="ContactAddress" id="ContactAddress" size="40" required="required"/>
              </p>
              <p>Contact City:
  <input type="text" name="ContactCity" id="ContactCity" required="required"/>
                &nbsp;&nbsp;&nbsp;Contact State:
                ...
                &nbsp;&nbsp;&nbsp;Contact Zip Code:
                <input type="text" name="ContactZip" id="ContactZip" size="5" maxlength="5" required="required"/>
              </p>
              <p>Contact Phone Number:
  <input name="ContactNumber" id="ContactNumber" type="text" size="10" maxlength="10" required="required" />
                <i>(format: 5551112222)</i></p>
                <p>Contact E-Mail:
                <input type="text" name="ContactEmail" id="ContactEmail" size="50" required="required"/></p>
                ...
                <p>Request:
                <textarea name="Comment" id="Comment" cols="45" rows="5"></textarea> <i>(please be specific)</i></p>
              <?php if(($Type == 'Telephone') or ($Type == 'Mortgage/Rent') or ($Type == 'Electricity/Gas')) {
  ...
  <input type='text' name='CompanyName' id='CompanyName' size='50' required='required'/>
              </p>
              <p>Address:
  <input type='text' name='CompanyAddress' id='CompanyAddress' size='40' required='required'/>
              </p>
              <p>City:
  <input type='text' name='CompanyCity' id='CompanyCity' required='required'/>
                &nbsp;&nbsp;&nbsp;State:
                ...
                &nbsp;&nbsp;&nbsp;Zip Code:
                <input type='text' name='CompanyZip' id='CompanyZip' size='5' maxlength='5' required='required'/>
              </p>
              <p>Phone Number:
  <input name='CompanyNumber' id='CompanyNumber' type='text' size='10' maxlength='10' required='required' />
                <i>(format: 5551112222)</i></p>
				<p>Name on Account:
  <input type='text' name='BillingName' id='BillingName' size='50' required='required'/>
              </p>
			  <p>Due Date:
  <input type='text' name='BillingDate' id='BillingDate' size='10' required='required'/><a href='javascript:NewCal('BillingDate','MMddyyyy')'><img src='cal.gif' width='16' height='16' border='0' alt='Pick a date'></a>
<i>(format: mm/dd/yyyy)</i>
              </p>
			<p>Account Number: 
                <input type='text' name='Account' id='Account' size='20'/><i> (if applicable)</i>&nbsp;&nbsp;&nbsp;Amount: $
                <input type='text' name='Amount' id='Amount' size='20' required='required'/>
              </p>");	  
			  }
			  ?>
<h5 align="center">
